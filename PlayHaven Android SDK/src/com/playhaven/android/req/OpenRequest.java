...
extends PlayHavenRequest
{
    ...
    protected void serverSuccess(android.content.Context context) {
        ...
        // Temporarily hold onto this for updating preferences from the Json response...
    ...
    protected void handleResponse(String json)
    {
        ...
        try{
            ...
            if(newApiEndpoint != null)
            {
                ...
                editor.putString(key, newApiEndpoint);
                editor.commit();
        ...
        // We no longer need it.  Remove it to prevent any leak...
        context = null;
